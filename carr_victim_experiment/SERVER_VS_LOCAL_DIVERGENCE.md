...
- **✅ retained 已完成（2026-08-16 09:52）**：final eval 0/5000（0.0），during 0，
  at-retirement 0/0.0 —— 盾全程保留下违例严格为 0，与预期一致；服务器 sudden 的 0.75
  是撤盾后 raw policy 真实暴露，非盾结构故障。retained 与 noshield(0.237) 的对照
  (0 vs 0.237) 进一步确认服务器 final-eval 的 0.237 是无盾策略的收敛点，而非 instrument
  问题。
