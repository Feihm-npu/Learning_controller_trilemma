...
sudden, provenance-complete paired runs).  (a) At-retirement violation
fraction of the raw policy; (b) at-retirement raw-policy/shield disagreement;
(c) final violation fraction after clean post-retirement learning.  Poisoning
is confined to the shielded bootstrap phase.  The run-index-3 bars show the
fresh pair in Table~\ref{tab:carr-isolation}.}
