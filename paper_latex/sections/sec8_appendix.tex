...
Hsu et al.~\cite{hsu_sim_lab_real_2023} & no & partial & yes (transfer evidence)\\
...
Jiang et al.~\cite{jiang_backdoor_safe_rl_cps_2024} & yes (backdoor, triggered) & no (shield resident) & n/a\\
