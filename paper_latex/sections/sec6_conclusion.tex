...
horizons 3, 5, and 10 all separate the contracts.  An independent audit
finds that a one-step resident kernel still fails on 14/71, so the result
...
not beat freeze in the benign-adaptation smoke.  Thus resident predictive
evidence is contract-bound; raw release needs independent future coverage.
