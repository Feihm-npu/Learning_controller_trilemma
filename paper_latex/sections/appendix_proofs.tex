...
In the evaluated permanent-release transition, resident authority is removed
and a finite check authorizes an unmonitored future, so authority and horizon
change; under attack the update provenance becomes adversarial as well.
Evidence carried over from protected adaptation additionally changes subject,
from the composition to the raw policy, and the policy acts on deployment
observations.  The original evidence
