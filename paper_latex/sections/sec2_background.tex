...
data-collection transition safe, so no observation made during adaptation
reports on the raw policy that will later act alone.  Releasing that policy on
finite evidence collected under the shield exposes the delayed effect, and raw
release therefore requires evidence for the subject that receives action
authority.  Corrupted reward records are not needed to reach this mode; they
widen it, steering the trusted update rule toward a raw policy that fails
after retirement while every protected transition stays safe.
